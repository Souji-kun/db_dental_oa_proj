...
Public Class admin_treatments
    ...
    Private Sub admin_treatments_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles S_dID.Click
        Dim dID = tb3.Text
        Try
